...
// 최초 실행파일 순서
// _layout.js
// _layout.js 없으면 index.js

// 파일의 이름은 통상적으로 HomeScreen으로 작성
// 리액트 네이티브는 파일명과 컴포넌트명이 같지 않는 경우가 많음


// <View> -> html의 div와 같은 역할
// react native에서는 문자 작성시 반드시 <Text> 컴포넌트로 감싸야함.
...
// TextInput에 입력한 데이터를 저장할 state 변수
  ...
  return (
    // <SafeAreaView> : 폰 화면에서 툴바 영역을 제외한 나머지 영역만 사용할때
